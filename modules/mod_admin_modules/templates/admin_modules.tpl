...
action={dialog_open title="Zotonic Module Repository" template="action_dialog_zmr.tpl"} %}
    ...
    <p>{_ Zotonic is a modular web development framework. Most functionality is encapsulated inside modules. 
A set of basic modules are shipped with the Zotonic distribution,
